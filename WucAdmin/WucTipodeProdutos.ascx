<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WucTipodeProdutos.ascx.cs" Inherits="WucTipodeProdutos" %>
    ...
    <asp:View ID="View1" runat="server">
        <div style="border-right: black 1px solid; border-top: black 1px solid; margin-top: 15px;
            ...
            <div id="divTopo" style="width: 608px; border-bottom: black 1px solid;
                ...
                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="18px" Text="Tipos de Produtos"></asp:Label></div>
            <div style="width: 562px; height: 98px">
                <div style="padding-left: 7px; float: left; width: 340px; padding-top: 10px; height: 85px;
                    text-align: left;">
                    <asp:Label ID="Label9" runat="server" Text="Descrição do Tipo de Produto"></asp:Label>
            ...
            <div id="divPesquisa" style="border-top: black 1px solid; width: 607px; padding-top: 10px;
                ...
                <asp:GridView ID="grvTiposdeProdutos" runat="server" BackColor="White" BorderColor="#DEDFDE"
                    BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Vertical" AutoGenerateColumns="False"
                    EmptyDataText="Pressione o botão novo para cadastrar um tipo de produto" Width="595px"
                    OnRowDataBound="grvTiposdeProdutos_RowDataBound" DataKeyNames="CodTipo" TabIndex="5" ForeColor="Black" Height="1px" AllowPaging="True" PageSize="5">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="codTipo" HeaderText="C&#243;digo" Visible="False" />
                        <asp:BoundField DataField="DescTipo" HeaderText="Descri&#231;&#227;o do Tipo de Produto">
    ...
    <asp:View ID="View2" runat="server">
        <div style="border-right: black 1px solid; border-top: black 1px solid; margin-top: 15px;
            ...
            <div id="Div2" style="width: 608px; border-bottom: black 1px solid;
                height: 24px; background-color: #ffcc33; text-align: center">
                <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="18px" Text="Tipos de Produtos"></asp:Label></div>
            <div style="width: 607px; height: 74px">
                <table style="width: 597px; height: 60px; background-color: white" id="tblTiposdeProdutos"
                    runat="server" visible="true">
                    <tr>
                        <td style="width: 25px; height: 18px;">
                        </td>
                        <td style="width: 250px; text-align: right; height: 18px;">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 250px; text-align: right">
                            Descrição do Tipo de Produto</td>
                        <td style="width: 250px; text-align: left">
                            <asp:TextBox ID="txtDescTipo" runat="server" MaxLength="15" TabIndex="101" Width="220px"></asp:TextBox></td>
                        <td style="width: 25px">
                        </td>
                    </tr>
                </table>
